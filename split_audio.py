...
def split_new_recording(event, context):
    for record in event['Records']:
        ...
        contactId = str(key).lstrip("connect").replace(",","").replace("é","e").replace(" ","")
        ...
        left_result_key = destination_folder + left_key_prefix + contactId + '.wav'
        right_result_key = destination_folder + right_key_prefix + contactId + '.wav'
